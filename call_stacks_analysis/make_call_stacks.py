...
PARSER.add_argument('-e', '--extra-calls')
...
def validate(stack_usage: StackUsage, calls:Calls, api: API, white_list: WhiteList, skip_threshold: int) -> None:
        ...
        dump(not_called, 'not_called', not len(not_called) == 0)
        ...
        dump(no_api_connection, 'no_api_connection', not len(no_api_connection) == 0)
